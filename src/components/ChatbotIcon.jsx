    ...
    <>
      ...
      >
        <div className="relative">
          ...
          {/* Main button */}
          <div className="relative rounded-full bg-gradient-to-br from-blue-500 via-blue-600 to-cyan-600 p-4 md:p-4 shadow-[0_10px_25px_-5px_rgba(59,130,246,0.5)] hover:scale-110 transition-all duration-300 animate-floatSlow">
            <Bot className="w-7 h-7 md:w-7 md:h-7 text-white drop-shadow-sm" />
          </div>
        </div>
      </button>
