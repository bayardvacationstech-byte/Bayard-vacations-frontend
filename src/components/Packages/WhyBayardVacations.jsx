...
const WhyBayardVacations = () => {
  ...
  return (
    <section className="bg-white py-8 md:py-10 relative overflow-hidden rounded-3xl border border-slate-100 shadow-sm mb-4 md:mb-4">
      {/* Decorative Blur */}
                ...
                return (
                  <div key={index} className="flex flex-col sm:flex-row items-center sm:gap-5 gap-3 group w-full">
                    ...
                    <div className="flex flex-col min-w-0 text-center sm:text-left">
                      <div className="text-lg sm:text-xl md:text-2xl font-black text-slate-900 leading-none mb-1.5 tracking-tight group-hover:text-brand-blue transition-colors">
                        {stat.value}
                      </div>
