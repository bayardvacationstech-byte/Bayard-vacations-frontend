          ...
          <div className="bg-white rounded-[2.5rem] p-6 sm:p-10 md:p-16 shadow-2xl shadow-slate-200/50 border border-slate-100">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-16 px-2 sm:px-0">
               <div className="bg-emerald-50 rounded-3xl p-6 flex items-start gap-4 border border-emerald-100">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-slate-900 mb-1">Processing Window</h4>
               ...
               <div className="bg-sky-50 rounded-3xl p-6 flex items-start gap-4 border border-sky-100">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-slate-900 mb-1">Original Payment</h4>
            ...
            {/* THE CONTENT */}
            <div className="prose prose-slate max-w-none prose-headings:font-black prose-headings:tracking-tight prose-p:text-slate-600 prose-p:leading-relaxed prose-strong:text-slate-900 prose-a:text-brand-blue prose-h2:text-3xl">
              ...
              <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 mt-10">
                <h3 className="text-xl font-black text-slate-900 mb-4">How it works</h3>
              ...
              <div className="mt-12 p-8 bg-brand-blue rounded-3xl text-white relative overflow-hidden group text-center md:text-left">
                ...
                <a href="mailto:support@bayardvacations.com" className="inline-flex items-center justify-center px-8 py-3 bg-white text-brand-blue rounded-2xl font-black text-sm hover:bg-slate-50 transition-colors shadow-lg shadow-black/10">
